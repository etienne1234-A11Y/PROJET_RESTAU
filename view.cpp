...
void View::show_table_personnages() {
    ...
    label27->setGeometry(410,510,71,81);
           ...
           pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/maitrehoteldown.png");
    QLabel *label28 = new QLabel(leftPanel);
    label28 ->setPixmap(*pixmap);
    label->setScaledContents(true);
    label28->setGeometry(130,80,21,51);

    pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/serveurmovingdown.png");
    QLabel *label31 = new QLabel(leftPanel);
    label31->setPixmap(*pixmap);
    label->setScaledContents(true);
    label31->setGeometry(400,20,21,51);

    pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/Rangechief.png");
    QLabel *label29 = new QLabel(leftPanel);
    label29 ->setPixmap(*pixmap);
    label->setScaledContents(true);
    label29->setGeometry(200,230,21,51);

    pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/Rangechief.png");
    QLabel *label30 = new QLabel(leftPanel);
    label30 ->setPixmap(*pixmap);
    label->setScaledContents(true);
    label30->setGeometry(200,350,21,51);

    pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/serveurmovingdown.png");
    QLabel *label32 = new QLabel(leftPanel);
    label32->setPixmap(*pixmap);
    label->setScaledContents(true);
    label32->setGeometry(450,450,21,51);

    pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/MasterChefDown.png");
    QLabel *label33 = new QLabel(rightPanel);
    label33->setPixmap(*pixmap);
    label->setScaledContents(true);
    label33->setGeometry(350,71,51,51);

    pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/plongeurmovingdown.png");
    QLabel *label36 = new QLabel(rightPanel);
    label36->setPixmap(*pixmap);
    label->setScaledContents(true);
    label36->setGeometry(385,450,21,51);

    pixmap = new QPixmap( "F:/X3/programmation concurrente/restaurant_projet/resto_projet/images/commiscuisinedown.png");
    QLabel *label37 = new QLabel(rightPanel);
    label37->setPixmap(*pixmap);
    label->setScaledContents(true);
    label37->setGeometry(320,100,71,81);
